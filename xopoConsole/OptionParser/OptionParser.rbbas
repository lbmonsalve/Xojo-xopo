...
Protected Class OptionParser
	...
	#tag Method, Flags = &h0
		Function BooleanValue(key As Variant, defaultValue As Boolean = False) As Boolean
		  ...
		  If o Is Nil Or o.WasSet = False Then
		    Return defaultValue
		  Else
	...
	#tag Method, Flags = &h0
		Sub Constructor(appName As String = "", appDescription As String = "")
		  ...
		  Self.AppName = IIf(appName = "", App.ExecutableFile.Name, appName)
	...
	#tag Method, Flags = &h0
		Function DateValue(key As Variant, defaultValue As Date = Nil) As Date
		  ...
		  If v Is Nil Then Return defaultValue Else Return v.DateValue
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function DoubleValue(key As Variant, defaultValue As Double = 0.0) As Double
		  ...
		  If v Is Nil Then Return defaultValue Else Return v.DoubleValue
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function FileValue(key As Variant, defaultValue As FolderItem = Nil) As FolderItem
		  ...
		  If v Is Nil Then Return defaultValue Else Return FolderItem(v)
		End Function
	#tag EndMethod
		 ...
		 Shared Function GetRelativeFolderItem(path As String, relativeTo As FolderItem = Nil) As FolderItem
		  ...
		  #If TargetWin32 Then
		    ...
		    If path.Left(1) = pathSep Then
		      #If RBVersion< 2013
		        relativeTo = GetFolderItem(SpecialFolder.CurrentWorkingDirectory.AbsolutePath.Left(3))
		      #else
		  ...
		  #Else
		    ...
		    if path.Left(2) = "~/" then
		      #If RBVersion< 2013
		        path = SpecialFolder.UserHome.AbsolutePath + path.Mid(2)
		      #else
		  ...
		  #If RBVersion< 2013
		    path = relativeTo.AbsolutePath + pathSep + path
		  #else
	...
	#tag Method, Flags = &h0
		Function IntegerValue(key As Variant, defaultValue As Integer = 0) As Integer
		  ...
		  If v Is Nil Then Return defaultValue Else Return v.IntegerValue
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21, CompatibilityFlags = (TargetHasGUI)
		Private Shared Function ParseStringValue(value As String) As String()
		  ...
		  #If RBVersion< 2013
		    dim myPath as string = App.ExecutableFile.AbsolutePath
		  #else
	...
	#tag Method, Flags = &h0
		Function StringValue(key As Variant, defaultValue As String = "") As String
		  ...
		  If o Is Nil Or o.WasSet = False Or o.Value Is Nil Then Return defaultValue Else Return o.Value.StringValue
		End Function
	#tag EndMethod
